...
-- PASSWORD BUTTON SPACING FIX (v7.1)
-- Increase spacing between TextBox and Unlock button
if PasswordButton and PasswordInput then
    PasswordButton.Position = PasswordButton.Position + UDim2.new(0, 0, 0, 12)
end
