--// Advanced UI Library v4 ULTIMATE
--// Password Gate + Smooth Tabs + Theme System + Save/Load + Premium Animations
...
--[[ =========================
 V6 PATCH (NON-DESTRUCTIVE)
 Correções aplicadas:
 - Drag funcional (TopBar + Password)
 - Minimize e Close restaurados
 - Espaçamento Password UI corrigido
 - Scroll sem fundo branco
 - Background consistente
 - Tabs + animação mantidas
========================= ]]
...
if PasswordFrame then
    local pad = Instance.new("UIPadding", PasswordFrame)
...
if ScrollFrame then
    ...
    ScrollFrame.BackgroundColor3 = CurrentTheme.Background
end

-- MINIMIZE & CLOSE SAFETY
